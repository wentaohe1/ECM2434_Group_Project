    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='EcoffeeBase.user')),
            ],
            options={
                'constraints': [models.UniqueConstraint(fields=('userId', 'badgeId'), name='uniqueUserBadge')],
            },
        ),
        migrations.CreateModel(
            name='UserShop',
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('userId', 'shopId'), name='uniqueUserShop')],
            },
        ),
    ]
